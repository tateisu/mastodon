...
class FeedManager
  ...
  MAX_ITEMS = ENV['FEED_MAX_ITEMS'].present? ? ENV['FEED_MAX_ITEMS'].to_i : 800
  ...
  def merge_into_home(from_account, into_account)
    ...
    query        = from_account.statuses.list_eligible_visibility.includes(:preloadable_poll, :media_attachments, reblog: :account).limit(FeedManager::QUERY_LIMIT)
